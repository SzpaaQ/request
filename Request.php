...
CLASS Request
{
	 ...
	 */
	 public function getPost(string $key, string $type = null)
	 {
		 ...
		 switch(strtolower($type))
		 {
			 ...
			 case 'array':
				return is_object($value) || is_array($value) ? (array) $value : array();
			 break;
			 
			 case 'object':
				return is_object($value) || is_array($value) ? (object) $value : (object) array();
			 break;
	 ...
	 * */
	 public function hasFiles(string $name = null)
	 {
		 ...
		 return $name !== null ? (isset($_FILES[$name]) && $_FILES[$name] ? true : false) : isset($_FILES) && $_FILES ? true : false;
